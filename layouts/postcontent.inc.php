    ...
    <footer class="footer--global">
        <div class="grid__wrap">
            <div class="grid__span--2">
                <img alt="" class="img-circle" src="<?= $paths->imgs; ?>self-london.png" />
            </div>
            <div class="about-text grid__span--11">
                ...
                <div class="btn-row">
                    <a class="btn-row__btn btn btn--tertiary center-content" href="/Simon_Hudson_CV.pdf">
                    ...
                    <a class="btn-row__btn btn btn--tertiary center-content" href="https://github.com/simonhudson">
                        <span class="fa fa-github fa-2x margin-r-sm"></span>
                        <span class="">View my Github profile</span>
                    </a>
                </div>
            </div>
        </div>
