    ...
    <footer class="footer--global">
        <div class="grid__wrap">
            <div class="about-text grid__span--10">
            ...
            <div class="grid__span--6 grid__pull-right--2">
                <p>
                    <a class="footer__btn-link btn btn--tertiary center-content" href="/Simon_Hudson_CV.pdf">
                    ...
                    <a class="footer__btn-link btn btn--tertiary center-content" href="https://github.com/simonhudson">
